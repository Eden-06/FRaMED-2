...
public class RoleTypeInRoleGroupPattern extends RoleTypePattern {
	 ...
	 */
	roletype.group_constraints.Literals roleGroupLiterals = new roletype.group_constraints.Literals();
	
	/**
	 * the object to call utility operations of the role group feature on
	 */
	roletype.group_constraints.Util roleGroupUtil = new roletype.group_constraints.Util();
