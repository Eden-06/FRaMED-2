 ...
 * @generated
 */
public class FalseConstraintRuleItemProvider extends AbstractConstraintRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((FalseConstraintRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_FalseConstraintRule_type") :
			getString("_UI_FalseConstraintRule_type") + " " + label;
	}
