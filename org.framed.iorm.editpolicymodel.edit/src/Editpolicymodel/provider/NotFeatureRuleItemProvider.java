 ...
 * @generated
 */
public class NotFeatureRuleItemProvider extends AbstractFeatureRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((NotFeatureRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_NotFeatureRule_type") :
			getString("_UI_NotFeatureRule_type") + " " + label;
	}
