 ...
 * @generated
 */
public class TrueFeatureRuleItemProvider extends AbstractFeatureRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((TrueFeatureRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_TrueFeatureRule_type") :
			getString("_UI_TrueFeatureRule_type") + " " + label;
	}
