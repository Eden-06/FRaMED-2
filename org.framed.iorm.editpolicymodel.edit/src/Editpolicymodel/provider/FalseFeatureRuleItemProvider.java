 ...
 * @generated
 */
public class FalseFeatureRuleItemProvider extends AbstractFeatureRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((FalseFeatureRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_FalseFeatureRule_type") :
			getString("_UI_FalseFeatureRule_type") + " " + label;
	}
