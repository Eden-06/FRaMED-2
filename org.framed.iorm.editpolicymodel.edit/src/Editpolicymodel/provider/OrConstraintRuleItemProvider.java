 ...
 * @generated
 */
public class OrConstraintRuleItemProvider extends AbstractConstraintRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((OrConstraintRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_OrConstraintRule_type") :
			getString("_UI_OrConstraintRule_type") + " " + label;
	}
