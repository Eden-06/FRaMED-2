 ...
 * @generated
 */
public class TrueConstraintRuleItemProvider extends AbstractConstraintRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((TrueConstraintRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_TrueConstraintRule_type") :
			getString("_UI_TrueConstraintRule_type") + " " + label;
	}
