 ...
 * @generated
 */
public class AndFeatureRuleItemProvider extends AbstractFeatureRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((AndFeatureRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_AndFeatureRule_type") :
			getString("_UI_AndFeatureRule_type") + " " + label;
	}
