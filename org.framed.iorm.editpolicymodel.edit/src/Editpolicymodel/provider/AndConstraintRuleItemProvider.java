 ...
 * @generated
 */
public class AndConstraintRuleItemProvider extends AbstractConstraintRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((AndConstraintRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_AndConstraintRule_type") :
			getString("_UI_AndConstraintRule_type") + " " + label;
	}
