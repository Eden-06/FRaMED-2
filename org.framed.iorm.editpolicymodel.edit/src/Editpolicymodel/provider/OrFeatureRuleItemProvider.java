 ...
 * @generated
 */
public class OrFeatureRuleItemProvider extends AbstractFeatureRuleItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((OrFeatureRule)object).getArgument();
		return label == null || label.length() == 0 ?
			getString("_UI_OrFeatureRule_type") :
			getString("_UI_OrFeatureRule_type") + " " + label;
	}
