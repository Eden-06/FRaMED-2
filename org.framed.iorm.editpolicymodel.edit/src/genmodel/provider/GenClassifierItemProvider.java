...
public class GenClassifierItemProvider extends GenBaseItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GenClassifier_genPackage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GenClassifier_genPackage_feature", "_UI_GenClassifier_type"),
	...
	public String getText(Object object) {
		return getString("_UI_GenClassifier_type");
	}
