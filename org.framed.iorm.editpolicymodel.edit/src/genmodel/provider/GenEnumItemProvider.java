...
public class GenEnumItemProvider extends GenDataTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_GenEnum_typeSafeEnumCompatible_feature", "_UI_GenEnum_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_GenEnum_ecoreEnum_feature", "_UI_GenEnum_type"),
	...
	public String getText(Object object) {
		...
		return getString("_UI_GenEnum_type") + " " + genEnum.isTypeSafeEnumCompatible();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GenmodelPackage.Literals.GEN_ENUM__GEN_ENUM_LITERALS,
