 ...
 * <!-- end-user-doc -->
 * @see iorm.IormPackage
 * @generated
 */
public class IormSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static IormPackage modelPackage;
	...
	public IormSwitch() {
		if (modelPackage == null) {
			modelPackage = IormPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IormPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IormPackage.MODEL_ELEMENT: {
			...
			case IormPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IormPackage.RELATION: {
			...
			case IormPackage.SHAPE: {
				Shape shape = (Shape)theEObject;
				T result = caseShape(shape);
				if (result == null) result = caseModelElement(shape);
				if (result == null) result = caseNamedElement(shape);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IormPackage.SEGMENT: {
