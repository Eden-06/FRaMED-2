 ...
 * </p>
 * <ul>
 *   <li>{@link iorm.impl.SegmentImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SegmentImpl extends MinimalEObjectImpl.Container implements Segment {
	...
	protected EClass eStaticClass() {
		return IormPackage.Literals.SEGMENT;
	}
	...
	public EList<NamedElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<NamedElement>(NamedElement.class, this, IormPackage.SEGMENT__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IormPackage.SEGMENT__ELEMENTS:
