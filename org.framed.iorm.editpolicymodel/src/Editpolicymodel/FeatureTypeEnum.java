...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Feature Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see Editpolicymodel.EditpolicymodelPackage#getFeatureTypeEnum()
 * @model
 * @generated
 */
public enum FeatureTypeEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Feature Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FeatureTypeEnum[] VALUES_ARRAY =
		new FeatureTypeEnum[] {
			ACYCLIC,
			COMPARTMENT_TYPE,
			IRREFLEXIVE,
	...
	/**
	 * A public read-only list of all the '<em><b>Feature Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FeatureTypeEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Feature Type Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FeatureTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FeatureTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Feature Type Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static FeatureTypeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FeatureTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Feature Type Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FeatureTypeEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FeatureTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
