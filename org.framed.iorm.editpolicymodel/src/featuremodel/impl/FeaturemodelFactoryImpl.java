...
public class FeaturemodelFactoryImpl extends EFactoryImpl implements FeaturemodelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case FeaturemodelPackage.FRA_MED_FEATURE: return createFRaMEDFeature();
			case FeaturemodelPackage.FRA_MED_CONFIGURATION: return createFRaMEDConfiguration();
			default:
	 ...
	 * @generated
	 */
	public featuremodel.FeatureName createFeatureNameFromString(EDataType eDataType, String initialValue) {
		featuremodel.FeatureName result = featuremodel.FeatureName.get(initialValue);
