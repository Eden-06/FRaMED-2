		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActionTypeEnumAccess().getAlternatives(), "rule__ActionTypeEnum__Alternatives");
					put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
					put(grammarAccess.getPolicyAccess().getGroup(), "rule__Policy__Group__0");
					put(grammarAccess.getIsFeatureRuleAccess().getGroup(), "rule__IsFeatureRule__Group__0");
					...
					put(grammarAccess.getStepInAccess().getGroup(), "rule__StepIn__Group__0");
					...
					put(grammarAccess.getIsFeatureRuleAccess().getRuleAssignment_1(), "rule__IsFeatureRule__RuleAssignment_1");
					put(grammarAccess.getStepInRuleAccess().getRuleAssignment_1(), "rule__StepInRule__RuleAssignment_1");
